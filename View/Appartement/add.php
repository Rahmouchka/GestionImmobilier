...
<form action="../../Controller/Appartement/add.php" method="post" class="form-control" name="FormAjout">
    ...
    <input type="text" name="SurfaceEspaceCommun" class="form-control"><br>
